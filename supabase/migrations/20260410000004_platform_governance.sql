...
-- Create indexes for organization_signup_requests
...
-- Create indexes for client_access_requests
...
-- Create indexes for content_resources
...
-- Create indexes for setting_change_logs
...
-- Create indexes for platform_runtime_settings, temp credentials
...
-- Enable RLS on platform_runtime_settings and temp credentials
...
-- RLS policies for platform_runtime_settings
...
-- RLS policies for organization_staff_temp_credentials
...
-- RLS policies for client_temp_credentials
...
-- RLS policies for organization_signup_requests
...
-- RLS policies for client_access_requests
...
-- RLS policies for permission_overrides
...
-- RLS policies for setting_catalog
...
-- RLS policies for content_resources
...
-- RLS policies for setting_change_logs
