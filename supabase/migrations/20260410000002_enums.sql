-- =============================================================================
-- 002_enums.sql
-- Consolidated migration: All 64 enum types
-- =============================================================================

-- Pattern: Use DO $$ exception pattern for safe idempotent enum creation
-- This allows re-running migrations without errors if enums already exist
