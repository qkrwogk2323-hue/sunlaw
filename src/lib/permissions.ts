...
export const PERMISSION_GROUPS = {
  ...
  schedules: ['schedule_create', 'schedule_edit', 'schedule_confirm', 'calendar_export'],
  billing: ['billing_view', 'billing_issue', 'billing_payment_confirm', 'billing_export'],
  collection: ['collection_view', 'collection_contact_manage', 'collection_payment_plan_manage', 'collection_payment_confirm', 'collection_metrics_view'],
