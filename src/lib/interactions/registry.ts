...
export const INTERACTION_KEYS = {
  ...
  NOTIFICATIONS_ARCHIVE_LIST: 'notifications.archive.list',
...
export const INTERACTION_REGISTRY: Record<InteractionKey, InteractionDefinition> = {
  ...
  [INTERACTION_KEYS.NOTIFICATIONS_ARCHIVE_LIST]: {
    route: ROUTES.NOTIFICATIONS,
    type: INTERACTION_TYPES.NAVIGATE,
    state: {
      state: NOTIFICATION_STATE_KEYS.ARCHIVED.split('.').at(-1)
    },
    group: NOTIFICATION_GROUP_KEYS.ARCHIVE_LIST_NAV
  },
...
export const NOTIFICATION_INTERACTION_KEYS = {
  ...
  ARCHIVE_LIST: NOTIFICATION_NAV_KEYS.ARCHIVE_LIST
} as const;
