...
export function PremiumPageHeader({
  ...
  return (
    <header className={cn('rounded-[28px] border border-slate-200 bg-[linear-gradient(180deg,#ffffff,#eef6ff)] p-6 shadow-[0_18px_40px_rgba(15,23,42,0.08)] lg:p-8', className)}>
