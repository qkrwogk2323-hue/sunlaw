...
import { Upload, FileText, AlertTriangle, CheckCircle, ChevronDown, ChevronUp, Calculator, Trash2 } from 'lucide-react';
...
export function BankruptcyModuleClient({ caseId, organizationId, caseTitle, insolvencySubtype, creditors: initialCreditors, latestPlan, memberRole }: Props) {
