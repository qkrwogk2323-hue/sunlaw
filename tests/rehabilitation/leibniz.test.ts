...
describe('라이프니츠 현가계수 (P0-1)', () => {
  ...
  it('김한경: presentValue(561457, 36) === 18,961,470', () => {
    expect(presentValue(561_457, 36)).toBe(18_961_470);
  });

  it('48/60개월 검증 — 561,457원 월변제 기준', () => {
    // 561457 × 43.9555 = 24,679,123 (round)
    expect(presentValue(561_457, 48)).toBe(24_679_123);
    // 561457 × 53.6433 = 30,118,406 (round)
